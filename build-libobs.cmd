...
if not exist "%OBS_STUDIO_DIR%" (
	...
	cd "%OBS_STUDIO_DIR%"
	git apply "%BASE_DIR%\hook_patch.patch"
	cd "%OBS_STUDIO_BUILD_DIR%"
)
...
"C:\Program Files\CMake\bin\cmake" -G"Visual Studio 17 2022" ^
	...
	..
"C:\Program Files\CMake\bin\cmake" --build . --target install --config Release -v
